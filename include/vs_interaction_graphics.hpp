...
/*!
    ...
    The default format is Top-down greyscale image. If a different format is needed, create a new format argument.
    For example:
	\code
	...
    uint8_t image_buffer[16][16][3];
    vs_gui_imageformat_t format = {0};
	...
    format.pixel_bytes = 3;// '1' for greyscale, '3' for RGB
    format.is_bottom_to_top = 1;
    vs_gui_display_image(display_1,(uint8_t*)image_buffer,16,16,format);
	...
	\endcode
*/
